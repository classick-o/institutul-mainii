...
export default {
  ...
  steps: [
    {
      ...
      img: 'prompt-4',
      alt: 'Examinarea mâinii, cu lupă și lumină de cabinet',
    },
    {
      n: '02',
      time: '2–5 zile',
      ...
      img: 'prompt-5',
      alt: 'Planul de tratament și schemele mâinii, pe panouri',
    },
    {
      n: '03',
      time: '30–120 min',
      ...
      img: 'prompt-6',
      alt: 'Instrument microchirurgical și fir de sutură',
    },
    {
      n: '04',
      time: '2–12 săpt.',
      ...
      img: 'prompt-7',
      alt: 'Exercițiu de recuperare cu sferă de rezistență',
    },
  ],
  ...
  /* Doar textul: numerotarea a ieșit. Un șir de dotări nu e o succesiune —
     microscopul nu vine înaintea ecografului — iar `01…03` pe o listă care nu
  ...
  pages: {
    home: {
      ...
      proceduresLink: 'Cum lucrăm, în detaliu',
