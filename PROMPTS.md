...
Deschiderea nu mai e o scără abstractă de sticlă, e o **fotografie documentară**
pe tot ecranul: o mână la terapie, cu orteză alături, lumină rece din dreapta.
Registrul e altul — nu materialitate, ci reportaj.

Gradarea e în albastru, nu neutră, și nu ca preferință: rama din jur — fundalul
secțiunii, perdelele, vigneta — e în familia `--blue-900`. O fotografie cu
cenușiuri neutre pusă într-o ramă albastră arată ca două materiale lipite, nu ca
un cadru.

> A cinematic documentary photograph of hand rehabilitation, graded entirely in
> cool deep blue. A hand working against a small therapy resistance device on a
> clean matte surface, a pale thermoplastic splint resting nearby. Lit by cool
> blue directional light coming from the right; the left half of the frame falls
> into deep indigo shadow and is empty. Shallow depth of field, focus on the
> fingers. The whole image sits in a deep navy blue palette — shadows in
> #0E1A5C, midtones in steel blue, highlights in pale cyan-white. Skin tones
> pulled cool and desaturated. Absolutely no warm tones, no amber, no orange,
> no green. Shot on a 50mm lens at f/2, natural film grain. Anatomically correct
> hand, exactly five fingers. No faces, no readable text, no letters, no logos,
> no wounds, no blood. Patient, methodical, quiet, expensive.

**Jumătatea din stânga trebuie să fie goală și întunecată.** Nu e o preferință:
acolo stau titlul, lead-ul și cifrele, albe. Primul cadru încercat pentru locul
ăsta era un cabinet fotografiat ziua, cu perete alb — avea zona liniștită în
stânga, deci ca să devină lizibil trebuia întunecat până când nu mai rămânea
nimic din el. Un cadru care cere o perdea groasă e un cadru greșit, nu o perdea
greșită.
...
blocul HERO. Pe scurt: fără ele, o fotografie de 2048px arată randată, nu
fotografiată.
...
e un termen de radiologie — sub o fotografie de implanturi ar fi o etichetă
...
| 5 | `prompt-4` … `prompt-7` | cardurile de proces, mai mici |
